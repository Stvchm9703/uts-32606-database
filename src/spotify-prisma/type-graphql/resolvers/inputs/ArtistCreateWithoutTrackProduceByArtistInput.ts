...
import { ArtistOnFollowingCreateNestedManyWithoutArtistInput } from "../inputs/ArtistOnFollowingCreateNestedManyWithoutArtistInput";

@TypeGraphQL.InputType("ArtistCreateWithoutTrackProduceByArtistInput", {
  isAbstract: true
})
export class ArtistCreateWithoutTrackProduceByArtistInput {
  ...
  @TypeGraphQL.Field(_type => ArtistOnFollowingCreateNestedManyWithoutArtistInput, {
    nullable: true
  })
  Followers?: ArtistOnFollowingCreateNestedManyWithoutArtistInput | undefined;
}
