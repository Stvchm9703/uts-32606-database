...
import { AlbumUpdateOneWithoutTracksNestedInput } from "../inputs/AlbumUpdateOneWithoutTracksNestedInput";
...
@TypeGraphQL.InputType("TrackUpdateWithoutAvailableMarketsInput", {
  isAbstract: true
})
export class TrackUpdateWithoutAvailableMarketsInput {
  ...
  @TypeGraphQL.Field(_type => AlbumUpdateOneWithoutTracksNestedInput, {
    nullable: true
  })
  Album?: AlbumUpdateOneWithoutTracksNestedInput | undefined;
}
