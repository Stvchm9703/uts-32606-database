...
export const categoriesRouter = t.router({
  aggregateCategory: publicProcedure
    .input(CategoryAggregateSchema).query(async ({ ctx, input }) => {
  ...
  createManyCategory: publicProcedure
    .input(CategoryCreateManySchema).mutation(async ({ ctx, input }) => {
  ...
  groupByCategory: publicProcedure
    .input(CategoryGroupBySchema).query(async ({ ctx, input }) => {
  ...
  updateManyCategory: publicProcedure
    .input(CategoryUpdateManySchema).mutation(async ({ ctx, input }) => {
