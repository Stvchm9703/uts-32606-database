...
const Schema: z.ZodType<Prisma.TrackUncheckedUpdateWithoutAvailableMarketsInput> =
  z
    .object({
      id: z
        .union([
...
export const TrackUncheckedUpdateWithoutAvailableMarketsInputObjectSchema =
  Schema;
