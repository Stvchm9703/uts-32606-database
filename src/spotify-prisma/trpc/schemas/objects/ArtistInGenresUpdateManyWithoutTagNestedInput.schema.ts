...
const Schema: z.ZodType<Prisma.ArtistInGenresUpdateManyWithoutTagNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistInGenresUpdateManyWithoutTagNestedInputObjectSchema = Schema;
