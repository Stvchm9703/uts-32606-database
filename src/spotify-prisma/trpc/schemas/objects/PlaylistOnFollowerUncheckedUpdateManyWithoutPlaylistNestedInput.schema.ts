...
const Schema: z.ZodType<Prisma.PlaylistOnFollowerUncheckedUpdateManyWithoutPlaylistNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PlaylistOnFollowerUncheckedUpdateManyWithoutPlaylistNestedInputObjectSchema =
  Schema;
