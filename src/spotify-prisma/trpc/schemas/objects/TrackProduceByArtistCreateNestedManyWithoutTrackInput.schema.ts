...
const Schema: z.ZodType<Prisma.TrackProduceByArtistCreateNestedManyWithoutTrackInput> =
  z
    .object({
      create: z
        .union([
...
export const TrackProduceByArtistCreateNestedManyWithoutTrackInputObjectSchema =
  Schema;
