...
const Schema: z.ZodType<Prisma.ArtistInGenresCreateNestedManyWithoutTagInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistInGenresCreateNestedManyWithoutTagInputObjectSchema = Schema;
