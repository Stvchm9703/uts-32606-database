...
const Schema: z.ZodType<Prisma.TracksOnPlaylistUncheckedUpdateManyWithoutTrackNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TracksOnPlaylistUncheckedUpdateManyWithoutTrackNestedInputObjectSchema =
  Schema;
