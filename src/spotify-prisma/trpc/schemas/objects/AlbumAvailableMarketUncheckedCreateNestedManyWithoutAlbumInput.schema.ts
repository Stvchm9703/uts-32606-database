...
const Schema: z.ZodType<Prisma.AlbumAvailableMarketUncheckedCreateNestedManyWithoutAlbumInput> =
  z
    .object({
      create: z
        .union([
...
export const AlbumAvailableMarketUncheckedCreateNestedManyWithoutAlbumInputObjectSchema =
  Schema;
