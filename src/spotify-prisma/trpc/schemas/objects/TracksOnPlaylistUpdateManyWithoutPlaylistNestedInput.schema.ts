...
const Schema: z.ZodType<Prisma.TracksOnPlaylistUpdateManyWithoutPlaylistNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TracksOnPlaylistUpdateManyWithoutPlaylistNestedInputObjectSchema =
  Schema;
