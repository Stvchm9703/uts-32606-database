...
const Schema: z.ZodType<Prisma.TrackProduceByArtistCreateNestedManyWithoutArtistsInput> =
  z
    .object({
      create: z
        .union([
...
export const TrackProduceByArtistCreateNestedManyWithoutArtistsInputObjectSchema =
  Schema;
