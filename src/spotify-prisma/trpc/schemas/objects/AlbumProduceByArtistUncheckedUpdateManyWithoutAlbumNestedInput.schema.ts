...
const Schema: z.ZodType<Prisma.AlbumProduceByArtistUncheckedUpdateManyWithoutAlbumNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AlbumProduceByArtistUncheckedUpdateManyWithoutAlbumNestedInputObjectSchema =
  Schema;
