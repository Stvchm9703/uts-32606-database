...
const Schema: z.ZodType<Prisma.TracksOnPlaylistCreateNestedManyWithoutTrackInput> =
  z
    .object({
      create: z
        .union([
...
export const TracksOnPlaylistCreateNestedManyWithoutTrackInputObjectSchema =
  Schema;
