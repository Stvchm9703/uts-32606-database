...
const Schema: z.ZodType<Prisma.AlbumProduceByArtistCreateNestedManyWithoutArtistInput> =
  z
    .object({
      create: z
        .union([
...
export const AlbumProduceByArtistCreateNestedManyWithoutArtistInputObjectSchema =
  Schema;
