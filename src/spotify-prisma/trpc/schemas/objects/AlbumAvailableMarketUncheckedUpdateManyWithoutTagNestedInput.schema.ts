...
const Schema: z.ZodType<Prisma.AlbumAvailableMarketUncheckedUpdateManyWithoutTagNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AlbumAvailableMarketUncheckedUpdateManyWithoutTagNestedInputObjectSchema =
  Schema;
