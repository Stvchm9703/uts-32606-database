...
const Schema: z.ZodType<Prisma.TracksOnPlaylistUncheckedCreateNestedManyWithoutPlaylistInput> =
  z
    .object({
      create: z
        .union([
...
export const TracksOnPlaylistUncheckedCreateNestedManyWithoutPlaylistInputObjectSchema =
  Schema;
