...
const Schema: z.ZodType<Prisma.TrackProduceByArtistUpdateManyWithoutTrackNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TrackProduceByArtistUpdateManyWithoutTrackNestedInputObjectSchema =
  Schema;
