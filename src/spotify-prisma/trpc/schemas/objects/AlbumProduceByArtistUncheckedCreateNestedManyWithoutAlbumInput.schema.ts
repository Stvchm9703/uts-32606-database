...
const Schema: z.ZodType<Prisma.AlbumProduceByArtistUncheckedCreateNestedManyWithoutAlbumInput> =
  z
    .object({
      create: z
        .union([
...
export const AlbumProduceByArtistUncheckedCreateNestedManyWithoutAlbumInputObjectSchema =
  Schema;
