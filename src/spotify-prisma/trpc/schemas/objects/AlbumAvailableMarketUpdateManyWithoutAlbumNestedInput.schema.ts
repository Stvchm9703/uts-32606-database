...
const Schema: z.ZodType<Prisma.AlbumAvailableMarketUpdateManyWithoutAlbumNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AlbumAvailableMarketUpdateManyWithoutAlbumNestedInputObjectSchema =
  Schema;
