...
const Schema: z.ZodType<Prisma.PlaylistOnFollowerUncheckedCreateNestedManyWithoutPlaylistInput> =
  z
    .object({
      create: z
        .union([
...
export const PlaylistOnFollowerUncheckedCreateNestedManyWithoutPlaylistInputObjectSchema =
  Schema;
