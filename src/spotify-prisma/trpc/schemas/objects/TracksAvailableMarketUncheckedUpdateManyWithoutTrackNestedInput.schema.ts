...
const Schema: z.ZodType<Prisma.TracksAvailableMarketUncheckedUpdateManyWithoutTrackNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TracksAvailableMarketUncheckedUpdateManyWithoutTrackNestedInputObjectSchema =
  Schema;
