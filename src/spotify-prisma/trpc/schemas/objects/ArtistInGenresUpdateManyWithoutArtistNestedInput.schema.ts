...
const Schema: z.ZodType<Prisma.ArtistInGenresUpdateManyWithoutArtistNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistInGenresUpdateManyWithoutArtistNestedInputObjectSchema =
  Schema;
