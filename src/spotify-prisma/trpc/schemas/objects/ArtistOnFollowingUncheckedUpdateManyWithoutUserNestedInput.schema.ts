...
const Schema: z.ZodType<Prisma.ArtistOnFollowingUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistOnFollowingUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
