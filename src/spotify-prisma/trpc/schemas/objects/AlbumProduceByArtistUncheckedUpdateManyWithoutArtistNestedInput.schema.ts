...
const Schema: z.ZodType<Prisma.AlbumProduceByArtistUncheckedUpdateManyWithoutArtistNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AlbumProduceByArtistUncheckedUpdateManyWithoutArtistNestedInputObjectSchema =
  Schema;
