...
const Schema: z.ZodType<Prisma.PlaylistUncheckedCreateNestedManyWithoutOwnerInput> =
  z
    .object({
      create: z
        .union([
...
export const PlaylistUncheckedCreateNestedManyWithoutOwnerInputObjectSchema =
  Schema;
