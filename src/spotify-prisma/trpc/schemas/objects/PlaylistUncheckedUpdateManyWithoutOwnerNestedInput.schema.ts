...
const Schema: z.ZodType<Prisma.PlaylistUncheckedUpdateManyWithoutOwnerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => PlaylistUpdateManyWithWhereWithoutOwnerInputObjectSchema,
          ),
          z
            .lazy(
              () => PlaylistUpdateManyWithWhereWithoutOwnerInputObjectSchema,
...
export const PlaylistUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema =
  Schema;
