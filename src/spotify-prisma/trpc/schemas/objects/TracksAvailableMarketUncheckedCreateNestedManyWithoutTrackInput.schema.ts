...
const Schema: z.ZodType<Prisma.TracksAvailableMarketUncheckedCreateNestedManyWithoutTrackInput> =
  z
    .object({
      create: z
        .union([
...
export const TracksAvailableMarketUncheckedCreateNestedManyWithoutTrackInputObjectSchema =
  Schema;
