...
const Schema: z.ZodType<Prisma.ArtistOnFollowingUncheckedCreateNestedManyWithoutArtistInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistOnFollowingUncheckedCreateNestedManyWithoutArtistInputObjectSchema =
  Schema;
