...
const Schema: z.ZodType<Prisma.ArtistInGenresCreateNestedManyWithoutArtistInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistInGenresCreateNestedManyWithoutArtistInputObjectSchema =
  Schema;
