...
const Schema: z.ZodType<Prisma.ArtistOnFollowingCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistOnFollowingCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
