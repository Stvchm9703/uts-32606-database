...
const Schema: z.ZodType<Prisma.PlaylistOnFollowerCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const PlaylistOnFollowerCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
