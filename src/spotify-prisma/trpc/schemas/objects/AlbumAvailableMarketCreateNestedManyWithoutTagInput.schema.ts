...
const Schema: z.ZodType<Prisma.AlbumAvailableMarketCreateNestedManyWithoutTagInput> =
  z
    .object({
      create: z
        .union([
...
export const AlbumAvailableMarketCreateNestedManyWithoutTagInputObjectSchema =
  Schema;
