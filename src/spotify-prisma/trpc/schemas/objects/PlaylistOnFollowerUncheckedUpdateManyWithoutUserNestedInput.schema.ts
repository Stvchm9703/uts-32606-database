...
const Schema: z.ZodType<Prisma.PlaylistOnFollowerUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PlaylistOnFollowerUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
