...
const Schema: z.ZodType<Prisma.TracksAvailableMarketCreateNestedManyWithoutTagInput> =
  z
    .object({
      create: z
        .union([
...
export const TracksAvailableMarketCreateNestedManyWithoutTagInputObjectSchema =
  Schema;
