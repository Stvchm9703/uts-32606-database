...
const Schema: z.ZodType<Prisma.TracksAvailableMarketUpdateManyWithoutTagNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TracksAvailableMarketUpdateManyWithoutTagNestedInputObjectSchema =
  Schema;
