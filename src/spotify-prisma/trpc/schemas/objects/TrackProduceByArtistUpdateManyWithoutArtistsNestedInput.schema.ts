...
const Schema: z.ZodType<Prisma.TrackProduceByArtistUpdateManyWithoutArtistsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TrackProduceByArtistUpdateManyWithoutArtistsNestedInputObjectSchema =
  Schema;
