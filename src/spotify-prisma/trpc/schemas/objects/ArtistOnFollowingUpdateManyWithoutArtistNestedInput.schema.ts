...
const Schema: z.ZodType<Prisma.ArtistOnFollowingUpdateManyWithoutArtistNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ArtistOnFollowingUpdateManyWithoutArtistNestedInputObjectSchema =
  Schema;
