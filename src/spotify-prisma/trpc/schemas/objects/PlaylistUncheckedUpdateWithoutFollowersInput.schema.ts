...
const Schema: z.ZodType<Prisma.PlaylistUncheckedUpdateWithoutFollowersInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const PlaylistUncheckedUpdateWithoutFollowersInputObjectSchema = Schema;
